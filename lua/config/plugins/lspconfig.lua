...
M.config = {
	{
		'https://github.wisteria.cf/weilbith/nvim-code-action-menu',
		cmd = 'CodeActionMenu',
	},
	{
		'https://github.wisteria.cf/VonHeikemen/lsp-zero.nvim',
		branch = 'v2.x',
		dependencies = {
			{
				"https://github.wisteria.cf/folke/trouble.nvim",
				opts = {
			...
			{ 'https://github.wisteria.cf/neovim/nvim-lspconfig' },
			{
				'https://github.wisteria.cf/williamboman/mason.nvim',
				build = function()
					vim.cmd([[MasonInstall]])
				end,
			},
			{ 'https://github.wisteria.cf/williamboman/mason-lspconfig.nvim' },
			{ 'https://github.wisteria.cf/hrsh7th/cmp-nvim-lsp' },
			{
				'https://github.wisteria.cf/j-hui/fidget.nvim',
				tag = "legacy"
			},
			"https://github.wisteria.cf/folke/neodev.nvim",
			"https://github.wisteria.cf/ray-x/lsp_signature.nvim",
			"https://github.wisteria.cf/ldelossa/nvim-dap-projects",
			{
				"https://github.wisteria.cf/lvimuser/lsp-inlayhints.nvim",
				branch = "anticonceal",
			},
