...
local M = {}
M.config = {
	"https://github.wisteria.cf/hrsh7th/nvim-cmp",
	after = "https://github.wisteria.cf/SirVer/ultisnips",
	dependencies = {
		"https://github.wisteria.cf/hrsh7th/cmp-buffer",
		"https://github.wisteria.cf/hrsh7th/cmp-path",
		"https://github.wisteria.cf/hrsh7th/cmp-nvim-lsp",
		"https://github.wisteria.cf/hrsh7th/cmp-nvim-lua",
		"https://github.wisteria.cf/hrsh7th/cmp-calc",
		-- "andersevenrud/cmp-tmux",
		{
			"https://github.wisteria.cf/onsails/lspkind.nvim",
			lazy = false,
			config = function()
		...
		{
			"https://github.wisteria.cf/quangnguyen30192/cmp-nvim-ultisnips",
			config = function()
